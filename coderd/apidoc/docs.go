...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/experimental/chats/{chat}/side-questions": {
            "post": {
                "description": "Experimental: this endpoint is subject to change.",
                "consumes": [
                    "application/json"
                ...
                "operationId": "ask-chat-side-question",
                "parameters": [
                    {
                        "type": "string",
                        "format": "uuid",
                    ...
                    {
                        "description": "Create chat side question request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/codersdk.CreateChatSideQuestionRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/codersdk.CreateChatSideQuestionResponse"
                        }
                    }
                },
                "security": [
        ...
        "/api/experimental/chats/{chat}/side-questions/stream": {
            "post": {
                "description": "Experimental: this endpoint is subject to change.",
                "consumes": [
                    "application/json"
                ...
                "operationId": "stream-chat-side-question",
                "parameters": [
                    {
                        "type": "string",
                        "format": "uuid",
    ...
    "definitions": {
        ...
        "codersdk.ChatStreamActionRequired": {
            ...
            "properties": {
                "tool_calls": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/codersdk.ChatStreamToolCall"
                    }
                }
            }
        },
        "codersdk.ChatStreamEvent": {
            ...
            "properties": {
                "action_required": {
                    "$ref": "#/definitions/codersdk.ChatStreamActionRequired"
                },
                "chat_id": {
                    "type": "string",
                    "format": "uuid"
        ...
        "codersdk.ChatStreamEventType": {
            ...
            "x-enum-varnames": [
                ...
                "ChatStreamEventTypeMessage",
                "ChatStreamEventTypeStatus",
        ...
        "codersdk.ChatStreamRetry": {
            ...
            "properties": {
                ...
                "delay_ms": {
                    "description": "DelayMs is the backoff delay in milliseconds before the retry.",
                    "type": "integer"
                },
                "error": {
                    "description": "Error is the normalized error message from the failed attempt.",
                    "type": "string"
                },
                "kind": {
                ...
                "retrying_at": {
                    "description": "RetryingAt is the timestamp when the retry will be attempted.",
                    "type": "string",
                    "format": "date-time"
                },
                "status_code": {
        ...
        "codersdk.CreateChatRequest": {
            ...
            "properties": {
                ...
                "unsafe_dynamic_tools": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/codersdk.DynamicTool"
                    }
                },
                "workspace_id": {
                    "type": "string",
        ...
        "codersdk.CreateChatSideQuestionRequest": {
            ...
            "properties": {
                ...
                "transient_context": {
                    "$ref": "#/definitions/codersdk.ChatSideQuestionTransientContext"
                }
            }
        },
        ...
        "codersdk.Experiment": {
            ...
            "x-enum-comments": {
                ...
                "ExperimentChatSideQuestions": "Enables one-shot side questions for chats.",
            ...
            "x-enum-descriptions": [
                ...
                "Enables one-shot side questions for chats."
            ],
            "x-enum-varnames": [
                "ExperimentExample",
        ...
        "codersdk.WorkspaceAgentGitServerMessage": {
            ...
            "properties": {
                ...
                "repositories": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/codersdk.WorkspaceAgentRepoChanges"
                    }
                },
                "scanned_at": {
                    "type": "string",
                ...
                "type": {
                    "$ref": "#/definitions/codersdk.WorkspaceAgentGitServerMessageType"
                }
            }
        },
